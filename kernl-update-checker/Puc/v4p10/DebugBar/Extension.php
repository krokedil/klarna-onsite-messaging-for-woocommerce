...
if ( !class_exists('Puc_v4p10_DebugBar_Extension', false) ):
	...
	class Puc_v4p10_DebugBar_Extension {
		...
		private function getLibraryUrl($filePath) {
			...
			$absolutePath = Puc_v4p10_FactoryKernl::normalizePath($absolutePath);

			$pluginDir = Puc_v4p10_FactoryKernl::normalizePath(WP_PLUGIN_DIR);
			$muPluginDir = Puc_v4p10_FactoryKernl::normalizePath(WPMU_PLUGIN_DIR);
			$themeDir = Puc_v4p10_FactoryKernl::normalizePath(get_theme_root());
